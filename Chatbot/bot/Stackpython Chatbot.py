...
def generating_answer(question_from_dailogflow_dict):
    ...
    #### request_data (new) ####
    elif intent_group_question_str == 'request_schedule':
        answer_str = request_schedule(question_from_dailogflow_dict)
    elif intent_group_question_str == 'data_schedule - yes':
        answer_str = data_schedule(question_from_dailogflow_dict)
        print("yes")
    #### request_data (new) #### nowwwwwwwwwwwww
